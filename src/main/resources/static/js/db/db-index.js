...
class DbIndex extends LitElement {
    static styles = css`
    ...
    render(){
        return html`
          <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@48,400,0,0" />
           <caracal-card>
                <h1 slot="header">Postgres Database</h1>
                <div>
                    <menu>
                        <a href="#" class="active" data-elm="db-customers" @click=${this._clickHandler}>
                            <slot>
...
customElements.define('db-index', DbIndex);